...
public class ItemsModel {
	...
	private String item_id, enterprise_id, item_name, measurement, hsn_o_sac, item_description;
	
	public ItemsModel() {
		
	}

	public ItemsModel(int item_type_code, double purchased_quantity, double sold_quantity, double available_quantity, String item_id, String enterprise_id, String item_name, String measurement, String hsn_o_sac, String item_description) {
